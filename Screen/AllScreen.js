...
export default class ForgotScreen  extends Component {
  ...
  getMeta2 = (url) => {  
    ...
    onScrollEnd( event ) {
      ...
      if ( scrollHeight >= height  && !this.props.noScroll) {
        this.load();
      }
    }
        ...
        return (
          ...
          <Masonry onMomentumScrollEnd={this.onScrollEnd.bind( this )}
               ...
               renderItem={item => <TouchableOpacity
                 ...
                 <View style={{marginTop:10, flexDirection:'row',padding:20,borderColor:'#0000000d',borderWidth:1,borderStyle:'solid',borderRadius:5}}>
                        <Image resizeMode="contain" source={{uri:item.image != null?item.image:'https://cdn2.iconfinder.com/data/icons/gaming-and-beyond-part-2-1/80/User_gray-512.png'}} style={{width:50,height:50, flexDirection:'column',padding:20,borderColor:'#0000000d',borderWidth:1,borderStyle:'solid',borderRadius:5}} />

                        <View style={{marginLeft:10, flexDirection:'column',borderColor:'#0000000d',borderWidth:0,borderStyle:'solid',borderRadius:5}}>
                            <View style={{flexDirection:'row'}}>
                                <Text style={{fontSize:14,lineHeight:20}}>{item.user}</Text>
                            </View>
                        </View>
                    </View>
               </TouchableOpacity>}/>
