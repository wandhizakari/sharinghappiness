...
export default class ForgotScreen  extends Component {
    ...
    load() {
      ...
      let url =`https://sharinghappiness.org/api/v1/faq`
      fetch(url, {
        method: 'GET',
        headers: {
        ...
        return (
          ...
          <Masonry onMomentumScrollEnd={this.onScrollEnd.bind( this )}
               ...
               renderItem={item => <TouchableOpacity
                 ...
                 <View style={{backgroundColor:'#eb6623',padding:10}}><Text style={{color:'white'}}>{item.question}</Text></View>
                 <View style={{backgroundColor:'white',padding:10}}><Text>{item.answer.replace("&lt;ol&gt;", "").replace("&lt;li&gt;", "").replace("&lt;/ol&gt;", "").replace("&lt;/p&gt;", "").replace("&lt;/li&gt;", "").replace("&lt;li&gt;", "")}</Text></View>
