...
export default class ForgotScreen  extends Component {
    ...
    load() {
      ...
      let url =`https://sharinghappiness.org/api/v1/user/wishlist?token=${token}&token_email=${email}`
      ...
      fetch(url, {
        ...
        .then((responseJson) => {
          ...
          if(this.props.title == 'Zakat' || this.props.title == 'Infaq'|| this.props.title == 'Shodaqoh' || this.props.title == 'Waqaf'){
